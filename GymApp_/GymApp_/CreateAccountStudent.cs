...
{
    public partial class CreateAccountStudent : Form
    {
        ...
        private void CreateAccountStudent_Load(object sender, EventArgs e)
        {
        ...
        private void CreateAccountButton_Click(object sender, EventArgs e)
        {
            ...
            int newId = id + 1;
            if (Validation.Validate(ForenameTB.Text, SurnameTB.Text, EmailTB.Text, PassTB.Text) == true && MotivationTBDB.SelectedItem != null)
            {
                doc.Element("Users").Element("Students").Add(
                new XElement("record",
                    ...
                    new XElement("Motivation", MotivationTBDB.SelectedItem)));
                doc.Save(fileName);
